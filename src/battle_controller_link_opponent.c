...
static void LinkOpponentEndExecution(void);
...
static void (*const sLinkOpponentBufferCommands[CONTROLLER_CMDS_COUNT])(void) =
{
    ...
    [CONTROLLER_GETRAWMONDATA]            = LinkOpponentEndExecution,
    ...
    [CONTROLLER_PALETTEFADE]              = LinkOpponentEndExecution,
    [CONTROLLER_SUCCESSBALLTHROWANIM]     = LinkOpponentEndExecution,
    [CONTROLLER_BALLTHROWANIM]            = LinkOpponentEndExecution,
    [CONTROLLER_PAUSE]                    = LinkOpponentEndExecution,
    [CONTROLLER_MOVEANIMATION]            = LinkOpponentHandleMoveAnimation,
    [CONTROLLER_PRINTSTRING]              = LinkOpponentHandlePrintString,
    [CONTROLLER_PRINTSTRINGPLAYERONLY]    = LinkOpponentEndExecution,
    [CONTROLLER_CHOOSEACTION]             = LinkOpponentEndExecution,
    [CONTROLLER_YESNOBOX]                 = LinkOpponentEndExecution,
    [CONTROLLER_CHOOSEMOVE]               = LinkOpponentEndExecution,
    [CONTROLLER_OPENBAG]                  = LinkOpponentEndExecution,
    [CONTROLLER_CHOOSEPOKEMON]            = LinkOpponentEndExecution,
    [CONTROLLER_23]                       = LinkOpponentEndExecution,
    [CONTROLLER_HEALTHBARUPDATE]          = LinkOpponentHandleHealthBarUpdate,
    [CONTROLLER_EXPUPDATE]                = LinkOpponentEndExecution,
    ...
    [CONTROLLER_STATUSXOR]                = LinkOpponentEndExecution,
    [CONTROLLER_DATATRANSFER]             = LinkOpponentEndExecution,
    [CONTROLLER_DMA3TRANSFER]             = LinkOpponentEndExecution,
    [CONTROLLER_PLAYBGM]                  = LinkOpponentEndExecution,
    [CONTROLLER_32]                       = LinkOpponentEndExecution,
    [CONTROLLER_TWORETURNVALUES]          = LinkOpponentEndExecution,
    [CONTROLLER_CHOSENMONRETURNVALUE]     = LinkOpponentEndExecution,
    [CONTROLLER_ONERETURNVALUE]           = LinkOpponentEndExecution,
    [CONTROLLER_ONERETURNVALUE_DUPLICATE] = LinkOpponentEndExecution,
    [CONTROLLER_CLEARUNKVAR]              = LinkOpponentEndExecution,
    [CONTROLLER_SETUNKVAR]                = LinkOpponentEndExecution,
    [CONTROLLER_CLEARUNKFLAG]             = LinkOpponentEndExecution,
    [CONTROLLER_TOGGLEUNKFLAG]            = LinkOpponentEndExecution,
    [CONTROLLER_HITANIMATION]             = LinkOpponentHandleHitAnimation,
    [CONTROLLER_CANTSWITCH]               = LinkOpponentEndExecution,
    ...
    [CONTROLLER_ENDBOUNCE]                = LinkOpponentEndExecution,
