...
static void SetCursorMonData(void *pokemon, u8 mode)
{
    ...
    else if (mode == MODE_BOX)
    {
        ...
        if (sPSSData->cursorMonSpecies != SPECIES_NONE)
        {
            ...
            sPSSData->cursorMonPalette = GetMonSpritePalFromSpeciesAndPersonality(GetFormSpeciesId(sPSSData->cursorMonSpecies, sPSSData->cursorMonForm), otId, sPSSData->cursorMonPersonality);
