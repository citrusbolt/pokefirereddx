...
static void LinkPartnerEndExecution(void);
...
static void (*const sLinkPartnerBufferCommands[CONTROLLER_CMDS_COUNT])(void) =
{
    ...
    [CONTROLLER_GETRAWMONDATA]            = LinkPartnerEndExecution,
    ...
    [CONTROLLER_TRAINERSLIDE]             = LinkPartnerEndExecution,
    [CONTROLLER_TRAINERSLIDEBACK]         = LinkPartnerHandleTrainerSlideBack,
    [CONTROLLER_FAINTANIMATION]           = LinkPartnerHandleFaintAnimation,
    [CONTROLLER_PALETTEFADE]              = LinkPartnerEndExecution,
    [CONTROLLER_SUCCESSBALLTHROWANIM]     = LinkPartnerEndExecution,
    [CONTROLLER_BALLTHROWANIM]            = LinkPartnerEndExecution,
    [CONTROLLER_PAUSE]                    = LinkPartnerEndExecution,
    [CONTROLLER_MOVEANIMATION]            = LinkPartnerHandleMoveAnimation,
    [CONTROLLER_PRINTSTRING]              = LinkPartnerHandlePrintString,
    [CONTROLLER_PRINTSTRINGPLAYERONLY]    = LinkPartnerEndExecution,
    [CONTROLLER_CHOOSEACTION]             = LinkPartnerEndExecution,
    [CONTROLLER_YESNOBOX]                 = LinkPartnerEndExecution,
    [CONTROLLER_CHOOSEMOVE]               = LinkPartnerEndExecution,
    [CONTROLLER_OPENBAG]                  = LinkPartnerEndExecution,
    [CONTROLLER_CHOOSEPOKEMON]            = LinkPartnerEndExecution,
    [CONTROLLER_23]                       = LinkPartnerEndExecution,
    [CONTROLLER_HEALTHBARUPDATE]          = LinkPartnerHandleHealthBarUpdate,
    [CONTROLLER_EXPUPDATE]                = LinkPartnerEndExecution,
    [CONTROLLER_STATUSICONUPDATE]         = LinkPartnerHandleStatusIconUpdate,
    [CONTROLLER_STATUSANIMATION]          = LinkPartnerHandleStatusAnimation,
    [CONTROLLER_STATUSXOR]                = LinkPartnerEndExecution,
    [CONTROLLER_DATATRANSFER]             = LinkPartnerEndExecution,
    [CONTROLLER_DMA3TRANSFER]             = LinkPartnerEndExecution,
    [CONTROLLER_PLAYBGM]                  = LinkPartnerEndExecution,
    [CONTROLLER_32]                       = LinkPartnerEndExecution,
    [CONTROLLER_TWORETURNVALUES]          = LinkPartnerEndExecution,
    [CONTROLLER_CHOSENMONRETURNVALUE]     = LinkPartnerEndExecution,
    [CONTROLLER_ONERETURNVALUE]           = LinkPartnerEndExecution,
    [CONTROLLER_ONERETURNVALUE_DUPLICATE] = LinkPartnerEndExecution,
    [CONTROLLER_CLEARUNKVAR]              = LinkPartnerEndExecution,
    [CONTROLLER_SETUNKVAR]                = LinkPartnerEndExecution,
    [CONTROLLER_CLEARUNKFLAG]             = LinkPartnerEndExecution,
    [CONTROLLER_TOGGLEUNKFLAG]            = LinkPartnerEndExecution,
    [CONTROLLER_HITANIMATION]             = LinkPartnerHandleHitAnimation,
    [CONTROLLER_CANTSWITCH]               = LinkPartnerEndExecution,
    ...
    [CONTROLLER_ENDBOUNCE]                = LinkPartnerEndExecution,
    ...
    [CONTROLLER_RESETACTIONMOVESELECTION] = LinkPartnerEndExecution,
...
static void LinkPartnerHandleLoadMonSprite(void)
{
	...
	species = GetFormSpecies(species, form);
...
static void LinkPartnerHandleDrawTrainerPic(void)
{
    ...
    {
        trainerPicId = gLinkPlayers[GetBattlerMultiplayerId(gActiveBattler)].gender + TRAINER_BACK_PIC_RS_BRENDAN;
    }
    ...
    if ((gLinkPlayers[GetBattlerMultiplayerId(gActiveBattler)].version & 0xFF) == VERSION_CRYSTAL_DUST)
    {
