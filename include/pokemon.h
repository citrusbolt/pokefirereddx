...
const struct SpritePalette *GetMonSpritePalStructFromOtIdPersonality(u16 formSpecies, u32 otId , u32 personality);
bool32 IsHMMove2(u16 move);
bool8 IsMonSpriteNotFlipped(u16 formSpecies);
